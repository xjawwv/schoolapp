...
func SetupRouter(socketServer *socketio.Server) *gin.Engine {
	...
	api := r.Group("/api")
	{
		...
		protected.Use(middleware.AuthMiddleware())
		{
			...
			protected.GET("/popups/unread", controllers.GetUnreadPopups)
			protected.GET("/popups/:id", controllers.GetPopupByID)
			protected.PUT("/popups/:id/read", controllers.MarkPopupRead)
